        ...
        child: ListView(
          children: [
            Container(
              ...
              child: Image.asset('/assets/login.png'), // Agrega la ruta de tu imagen
            ),
            Card(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              filled: true,
                              fillColor: Colors.purple[50], // Fondo morado claro
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary: Color.fromARGB(255, 29, 8, 119), // Color morado
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(20.0),
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () {
                              // Acciones al presionar "No tienes cuenta"
                            },
                            child: Text(
                              'Crear cuenta',
                              style: TextStyle(color: Colors.black),
